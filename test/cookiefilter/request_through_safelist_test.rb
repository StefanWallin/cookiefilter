...
class Cookiefilter::Test < ActiveSupport::TestCase
  ...
  #   # individuals below the COOKIE_LIMIT threshold.
  #   fake1 = Faker::Lorem.characters(Cookiefilter::Rules::COOKIE_LIMIT - 40)
  #   fake2 = Faker::Lorem.characters(Cookiefilter::Rules::COOKIE_LIMIT - 33)
